...
maindf.coalesce(1).write.parquet("s3://datalake-rawzone-grp041/datalake-8-sep/maintable")

repodf = df3.unionByName(df4)
repodf.coalesce(1).write.parquet("s3://datalake-rawzone-grp041/datalake-8-sep/repotable")

commitdf = df5.unionByName(df6)
commitdf.coalesce(1).write.parquet("s3://datalake-rawzone-grp041/datalake-8-sep/committable")  
